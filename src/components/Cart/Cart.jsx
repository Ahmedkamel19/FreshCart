          ...
          {cart.length > 0 ? (
            <>
              ...
              <button
                ...
                type="submit"
                className="text-white w-full my-4 mx-auto duration-300 bg-orange-500 hover:bg-orange-800 focus:ring-4 focus:outline-none focus:ring-orange-300 font-medium rounded-lg text-sm  px-5 py-2.5 text-center "
              >
                Check Out
              </button>
            </>
